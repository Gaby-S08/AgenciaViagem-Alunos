...
A **Agência Viagem** é uma Landing Page moderna e responsiva desenvolvida com foco em **SEO (Search Engine Optimization)** e boas práticas de Front-end. O projeto simula a página de uma agência de viagem apresentando pacotes de promoção e destinos. 
...
├── Layout_viagens.pdf # Layout do site
